...
public interface IRepositorioUsuario {
     ...
     *
     */
    Usuario procurar(UUID id) throws ElementoNaoExisteException;
     ...
     */
    void atualizar(UUID idAntigo, Usuario novo) throws ElementoNullException, ElementoNaoExisteException;
